...
const IndexPage = () => {
  ...
  function updateCo2e(quantity) {
    co2e = 10 * quantity
    window.alert('updateCo2e: ' + co2e)
  }

  function Co2eAmount(props) {
    const amount = (props.co2e * props.quantity).toFixed(0);
  ...
  class FoodInput extends React.Component {
    ...
    onTagsChange = (event, values) => {
      ...
      if (values !== null) {
        this.props.onFoodChange(values.co2e)
      }

...
const foods = [
    ...
    { food: 'Småkage, hvede, traditionelle danske, industrifremstillet', co2e: 2.98118906818497 },
    { food: 'Småkage, cookie (amerikansk type), industrifremstillet', co2e: 2.72977724450129 },
    ...
    { food: 'Hvedebrød, toastbrød, fint, industrifremstillet', co2e: 0.739255008345281 },
    ...
    { food: 'Kage, trøffelprodukt / koldprodukt, industrifremstillet', co2e: 2.6283659205087 },
    ...
    { food: 'Mineralvand, sodavand, tilsat sukker, uspec.', co2e: 0.548131282318376 },
    ...
    { food: 'Margarine, 70 %, bordbrug, blød, vegetabilsk fedt', co2e: 2.92753970672067 },
    ...
    { food: 'Kyllingenuggets, friturestegt, færdigretter', co2e: 3.24193520508814 },
    { food: 'Pizza med tomat og ost, færdigretter', co2e: 2.96194132682152 },
    { food: 'Pizza med fisk, tomat og ost, færdigretter', co2e: 3.79384723952161 },
    { food: 'Pizza med salami, tomat og ost, færdigretter', co2e: 3.1528464388902 },
    { food: 'Pizza med grønt og frugt, tomat og ost, færdigretter', co2e: 2.55688011661896 },
    { food: 'Pizza med kød, tomat og ost, færdigretter', co2e: 3.90761971549838 },
    { food: 'Pizza med kød og fisk, tomat og ost, færdigretter', co2e: 3.85073347750999 },
    ...
    { food: 'Grisekød, nakkefilet, helt afpudset (Nakkekotelet), rå', co2e: 3.56827099775408 },
    ...
    { food: 'Grisekød i karrysovs, dybfrost, færdigretter', co2e: 3.81662746962554 },
    { food: 'Pizza romana, dybfrost, færdigretter', co2e: 2.87365071618733 },
    { food: 'Lever, gris, i flødesovs, dybfrost, færdigretter', co2e: 2.89566059199282 },
    ...
    { food: 'Pizza med broccoli, dybfrost, færdigretter', co2e: 2.58476124661416 },
    ...
    { food: 'Baked beans/hvide bønner i tomatsovs, konserves', co2e: 1.52538988758479 },
    ...
    { food: 'Boller i karry med ris og karrysauce, færdigretter', co2e: 1.94111856137399 },
